#ifndef _PRO_IO_PNG_H
#define _PRO_IO_PNG_H

/** @file proIoPng.h
 \brief Contains an image loder class for Portable Network Graphics (PNG) files
...
//--- class ioPng ---------------------------------------------
/// an image loader class for Portable Network Graphics (PNG) files
class ioPng {
public:
    /// loads a PNG file into an Image object
    /** \param filename the file to be loaded,
         \return pointer to an Image object in case of success or 0. */
    static Image * load(const std::string & filename);
	/// saves an Image to a PNG file using the default settings
